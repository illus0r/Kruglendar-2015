# -*- coding: utf-8 -*-
import sys, svgwrite, math, numpy
...
if __name__ == '__main__':
  ...
  yearDays = ["%d %s"%(date+1, mounthes[mounthIndex]) \
            for mounthIndex, dayAmount in enumerate(mounthDays) \
            for date in range(dayAmount)]
